...
description: When to create plugins vs using existing ones
---

## When to Create Plugins

Create plugins when you need to:

**Integrate with new APIs**: Connect to services not covered by existing plugins.

**Custom Data Processing**: Transform data in ways specific to your domain.

**Proprietary Systems**: Interface with internal or proprietary systems.

**Performance Optimization**: Optimize for specific use cases or data volumes.

## When to Use Existing Plugins

Use existing plugins when:

**Standard APIs**: Working with common services like social media, news feeds, or databases.

**Proven Solutions**: Leveraging battle-tested implementations.

**Rapid Development**: Getting to market quickly without custom development.

**Community Support**: Benefiting from community maintenance and updates.
