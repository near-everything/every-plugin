...
const runtime = createPluginRuntime({
  registry: {
    "plugin-id": {
      ...
      type: "source", // or "transformer", "pipeline"
      version: "1.0.0",
...
const plugin =
  yield *
  pluginRuntime.usePlugin("my-plugin", {
    secrets: {
...
const initialized =
  yield *
  pluginRuntime.initializePlugin(instance, {
...
- [Streaming](./stream) - Continuous data processing patterns
