...
Due to this paradigm, accessing a plugin's types can be difficult. 
To assist the `EveryPlugin` type offers a way to infer the types of a plugin from the provided runtime.
