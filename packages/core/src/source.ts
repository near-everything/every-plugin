 ...
 */
export interface PluginSourceItem<TRaw = Record<string, any>>
	extends Omit<BasePluginSourceItem, "raw"> {
 ...
 */
export interface SourceItem<TRaw = Record<string, any>>
	extends PluginSourceItem<TRaw> {
...
export interface SourceInput<TSearchOptions extends z.ZodTypeAny = z.ZodTypeAny>
	extends Input<z.ZodAny> {
	searchOptions: TSearchOptions;
	lastProcessedState?: LastProcessedState<PlatformState> | null;
}

export interface PluginSourceInput<TSearchOptions = Record<string, unknown>>
	extends Input<z.ZodAny> {
	searchOptions: TSearchOptions;
	lastProcessedState?: LastProcessedState<PlatformState> | null;
}

export interface PluginSourceOutputData<
	TItem extends PluginSourceItem = PluginSourceItem,
> {
	items: TItem[];
...
export interface PluginSourceOutput<
	TItem extends PluginSourceItem = PluginSourceItem,
> extends Output<z.ZodAny> {
	success: boolean;
