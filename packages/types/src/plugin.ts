...
export function createInputSchema<I extends z.ZodTypeAny>(inputSchema: I) {
	return inputSchema;
}
...
export type Input<I extends z.ZodTypeAny> = z.infer<
	ReturnType<typeof createInputSchema<I>>
>;
